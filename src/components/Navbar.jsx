...
//we just want to see avatr and username in small screen
const UserBox = styled(Box)(({ theme }) => ({
  display: "flex",
  alignItems: "center",
  gap: "10px",
  // small or bigger than small screen
  [theme.breakpoints.up("sm")]: {
    display: "none",
  },
}));
  ...
  return (
    <AppBar position="sticky">
      <StyledToolbar sx={{justifyContent: "space-between"}}>
        ...
        {/* jab scrren sm se choti hogi,  only avater and name appear hoga, icons will be hidden*/}
